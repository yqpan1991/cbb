 ...
 */
public class NormalRecommendFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.normal_recommend_fragment_layout, container, false);
    }
    ...
    private void loadData() {
        ...
        EsApiHelper.fetchRecommendList(RecommendInfo.RECOMMEND_TYPE_NORMAL, new Response.Listener<String>() {
            @Override
