 ...
 */
public class CommonDateFragment extends BaseFragment implements View.OnClickListener, EsUserManager.OnUserLogOperationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.common_date_fragment_layout, container, false);
    }
    ...
    private void loadData() {
        ...
        EsApiHelper.fetchRecommendList(RecommendInfo.RECOMMEND_TYPE_DATE, new Response.Listener<String>() {
            @Override
