 ...
 */
public class MyDateFragment extends BaseFragment implements View.OnClickListener, EsUserManager.OnUserLogOperationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.my_date_fragment_layout, container, false);
    }
